...
import { ComponentProps, Fragment, memo, useCallback, useEffect, useMemo } from "react";
  ...
  ({ tableId, schedules, onScheduleTimeClick, onDeleteButtonClick }: Props) => {
    ...
    return (
      ...
      >
        ...
        >
          <MemoGridItem onScheduleTimeClick={onScheduleTimeClick} />
        </Grid>

        {schedules.map((schedule, index) => (
          <MemoDraggableSchedule
...
const MemoDraggableSchedule = memo(
  ({
    id,
    data,
    bg,
